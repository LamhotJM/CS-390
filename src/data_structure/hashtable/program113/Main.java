...
public class Main {
	...
	public static void main(String[] args) {
		...
		HashMap<String, Employee> h = new HashMap<String, Employee>() {
			{
				...
				put("113145657",new Employee("Rick", 92000, "113145657"));  //exist
				put("342892138",new Employee("Ibu", 100000, "342892138")); //exist
		...
		SsnComparator ssncomp = new SsnComparator();
		Collections.sort(report,ssncomp);
